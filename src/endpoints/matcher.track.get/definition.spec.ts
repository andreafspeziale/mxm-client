...
import { mxmClientMatcherTrackGetResponseSchema } from './definition.js';
...
t.test('matcher.track.get definition (spec)', (t) => {
  ...
  t.test('Should reject a response with missing required field', (t) => {
    ...
    delete invalidResponse.message.body.track.track_id;
